  ...
  return (
    <main className="min-h-screen bg-white px-6 py-10 text-neutral-950 md:px-10">
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-xl flex-col justify-center">
        ...
        <h1 className="max-w-md text-4xl font-normal tracking-[-0.04em] md:text-6xl">
          Edição privada de projetos.
        </h1>
        <form action={loginAction} className="mt-12 space-y-7" noValidate>
          {errorMessage ? (
            <p
              className="border border-neutral-950 px-4 py-3 text-sm text-neutral-950"
              role="alert"
            >
              {errorMessage}
            </p>
          ...
          <div className="space-y-2">
            ...
            <input
              autoComplete="email"
              className="min-h-12 w-full border border-neutral-300 bg-white px-3 text-base outline-none transition-colors focus:border-neutral-950"
              id="email"
              name="email"
              required
              type="email"
          ...
          <button
            className="min-h-11 border border-neutral-950 px-5 text-sm uppercase tracking-[0.18em] transition-colors hover:bg-neutral-950 hover:text-white focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-neutral-950"
            type="submit"
          >
            Entrar
          </button>
