  ...
  return (
    <section className="border border-red-200 bg-white p-5 md:p-6">
      ...
      <form action={deleteProjectAction} className="mt-5">
        ...
        <button
          className="min-h-11 border border-red-700 px-5 text-admin-label uppercase tracking-[0.16em] text-red-700 hover:bg-red-700 hover:text-white focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-red-700"
          onClick={(event) => {
